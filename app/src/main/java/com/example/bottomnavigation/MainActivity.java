...
public class MainActivity extends AppCompatActivity {
                                                    ...
                                                    collectionRef.document(documentId)
                                                            ...
                                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                ...
                                                                public void onSuccess(Void aVoid) {
                                                                    ...
                                                                    DocumentReference documentRef = usersCollection.document(documentId);

                                                                    SaveHistory(data, container, sched_name,  currentDate, currentTime);
    ...
    private void SaveHistory(String data, String Container, String sched_name, String Date, String Time) {
